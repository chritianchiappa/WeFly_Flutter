...
class _ViaggiScreenState extends State<ViaggiScreen> {
  ...
  bool _filterViaggio(Map viaggio) {
    ...
    double compatibilityScore = _calculateCompatibility(List<String>.from(viaggio['Stili di viaggio']));
  ...
  double _calculateCompatibility(List<String> stiliViaggio) {
    ...
    return (stiliComuni / stiliViaggioUtente.length) * 100;
  }
            ...
            child: Container(
              ...
              child: snapshot.connectionState == ConnectionState.waiting
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Compatibilità: ${compatibilityScore.toStringAsFixed(1)}%',
                      style: TextStyle(
